...
def configuration(parent_package='',top_path=None):
    ...
    config = Configuration('prec', parent_package, top_path)
    ...
    src = ['sparsekit.f90', 'dlauc1.f', 'dgeqpw.f', 'dgeqpc.f', 'dtrrnk.f', 'dlasmx.f',\
           'dtrqxc.f','dgeqpx.f', 'dtrqpx.f', 'dgeqpb.f', 'dsort.f', 'blassm.f', 'matvec.f', 'unary.f', 'formats.f']
    ...
    local_src = ['prec.f90']
    config.add_extension('prec',sources=local_src,depends=['mylib', 'print_lib'],libraries=['mylib', 'print_lib', 'lapack', 'blas'])
